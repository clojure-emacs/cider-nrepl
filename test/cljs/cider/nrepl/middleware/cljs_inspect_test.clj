...
(def var-result ["(\"Class\" \": \" (:value \"clojure.lang.Cons\" 0) (:newline) \"Contents: \" (:newline) \"  \" \"0\" \". \" (:value \"var\" 1) (:newline) \"  \" \"1\" \". \" (:value \"cljs.core/*assert*\" 2) (:newline))"])
...
(def first-page-result
  ["(\"Class\" \": \" (:value \"clojure.lang.PersistentList\" 0) (:newline) \"Contents: \" (:newline) \"  \" \"0\" \". \" (:value \"0\" 1) (:newline) \"  \" \"1\" \". \" (:value \"1\" 2) (:newline) \"  \" \"2\" \". \" (:value \"2\" 3) (:newline) \"  \" \"3\" \". \" (:value \"3\" 4) (:newline) \"  \" \"4\" \". \" (:value \"4\" 5) (:newline) \"  ...\" (:newline) \"  Page size: 5, showing page: 1 of 7\")"])
