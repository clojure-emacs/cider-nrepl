...
[source,clojure]
----
{:user {:plugins [[cider/cider-nrepl "0.55.6"]]}}
----
...
[source,clojure]
----
:dependencies [[cider/cider-nrepl "0.55.6"]]
...
----
clj -Sdeps '{:deps {cider/cider-nrepl {:mvn/version "0.55.6"} }}' -M -m nrepl.cmdline --middleware "[cider.nrepl/cider-middleware]"
----
