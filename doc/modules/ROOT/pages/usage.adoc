...
[source,clojure]
----
:plugins [[cider/cider-nrepl "0.25.10"]]
----
...
[source,clojure]
----
{:user {:plugins [[cider/cider-nrepl "0.25.10"]]}}
----
...
----
boot -d nrepl:0.7.0 -d cider/cider-nrepl:0.25.10 -i "(require 'cider.tasks)" cider.tasks/add-middleware -m cider.nrepl.middleware.apropos/wrap-apropos -m cider.nrepl.middleware.version/wrap-version repl --server wait
----
...
----
clj -Sdeps '{:deps {cider/cider-nrepl {:mvn/version "0.25.10"} }}' -m nrepl.cmdline --middleware "[cider.nrepl/cider-middleware]"
----
...
{...
 ...
 {:cider-clj {:extra-deps {org.clojure/clojure {:mvn/version "1.10.1"}
                           cider/cider-nrepl {:mvn/version "0.25.10"}}
