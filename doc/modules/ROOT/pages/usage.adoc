...
[source,clojure]
----
{:user {:plugins [[cider/cider-nrepl "0.55.5"]]}}
----
...
[source,clojure]
----
:dependencies [[cider/cider-nrepl "0.55.5"]]
...
----
clj -Sdeps '{:deps {cider/cider-nrepl {:mvn/version "0.55.5"} }}' -M -m nrepl.cmdline --middleware "[cider.nrepl/cider-middleware]"
----
