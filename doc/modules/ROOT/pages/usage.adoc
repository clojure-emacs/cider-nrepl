...
----
boot -d nrepl:1.0.0 -d cider/cider-nrepl:0.28.7 -i "(require 'cider.tasks)" cider.tasks/add-middleware -m cider.nrepl.middleware.apropos/wrap-apropos -m cider.nrepl.middleware.version/wrap-version repl --server wait
----
...
----
clj -Sdeps '{:deps {cider/cider-nrepl {:mvn/version "0.28.7"} }}' -m nrepl.cmdline --middleware "[cider.nrepl/cider-middleware]"
----
