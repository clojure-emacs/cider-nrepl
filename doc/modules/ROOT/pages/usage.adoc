...
[source,clojure]
----
:plugins [[cider/cider-nrepl "0.55.2"]]
----
...
[source,clojure]
----
{:user {:plugins [[cider/cider-nrepl "0.55.2"]]}}
----
...
[source,clojure]
----
:dependencies [[cider/cider-nrepl "0.55.2"]]
...
----
clj -Sdeps '{:deps {cider/cider-nrepl {:mvn/version "0.55.2"} }}' -M -m nrepl.cmdline --middleware "[cider.nrepl/cider-middleware]"
----
