...
[source,clojure]
----
:plugins [[cider/cider-nrepl "0.62.0"]]
----
...
[source,clojure]
----
{:user {:plugins [[cider/cider-nrepl "0.62.0"]]}}
----
...
[source,clojure]
----
:dependencies [[cider/cider-nrepl "0.62.0"]]
...
----
clj -Sdeps '{:deps {cider/cider-nrepl {:mvn/version "0.62.0"} }}' -M -m nrepl.cmdline --middleware "[cider.nrepl/cider-middleware]"
----
