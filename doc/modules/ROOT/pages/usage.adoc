...
[source,clojure]
----
{:user {:plugins [[cider/cider-nrepl "0.49.2"]]}}
----
...
[source,clojure]
----
:dependencies [[cider/cider-nrepl "0.49.2"]]
...
----
clj -Sdeps '{:deps {cider/cider-nrepl {:mvn/version "0.49.2"} }}' -M -m nrepl.cmdline --middleware "[cider.nrepl/cider-middleware]"
----
