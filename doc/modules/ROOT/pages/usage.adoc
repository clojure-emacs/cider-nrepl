...
[source,clojure]
----
{:user {:plugins [[cider/cider-nrepl "0.37.0"]]}}
----
...
----
boot -d nrepl:1.0.0 -d cider/cider-nrepl:0.37.0 -i "(require 'cider.tasks)" cider.tasks/add-middleware -m cider.nrepl.middleware.apropos/wrap-apropos -m cider.nrepl.middleware.version/wrap-version repl --server wait
----
