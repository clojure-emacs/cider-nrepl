...
[source,clojure]
----
{:user {:plugins [[cider/cider-nrepl "0.28.1"]]}}
----
...
[source,clojure]
----
:dependencies [[cider/cider-nrepl "0.28.1"]]
...
----
boot -d nrepl:0.7.0 -d cider/cider-nrepl:0.28.1 -i "(require 'cider.tasks)" cider.tasks/add-middleware -m cider.nrepl.middleware.apropos/wrap-apropos -m cider.nrepl.middleware.version/wrap-version repl --server wait
----
...
----
clj -Sdeps '{:deps {cider/cider-nrepl {:mvn/version "0.28.1"} }}' -m nrepl.cmdline --middleware "[cider.nrepl/cider-middleware]"
----
