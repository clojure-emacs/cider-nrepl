...
Clojure editors, besides CIDER (e.g. `vim-fireplace`, `vim-iced`, Calva, Conjure).
...
Projects like https://github.com/tpope/vim-fireplace[vim-fireplace],
https://github.com/liquidz/vim-iced[vim-iced], https://calva.io/[Calva] and
https://github.com/Olical/conjure[Conjure] are making use of cider-nrepl already.
...
The exception to this rule are the artifacts that are themselves part of the
CIDER ecosystem and are kept as regular runtime dependencies:
