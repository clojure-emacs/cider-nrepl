...
Deprecated: use ``cider/format-code`` instead. Reformats the given Clojure code, returning the result as a string.
...
Deprecated: use ``cider/slurp`` instead. Slurps a URL from the nREPL server, returning MIME data.
