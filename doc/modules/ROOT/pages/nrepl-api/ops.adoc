...
Print the current value of the inspector. The printed result may be
delivered in multiple messages under their `:value` key. After
printing the value a message with `:status` "done" is sent.
