...
compatibility between major releases is not a concern (although we try
to break the API rarely and for a good reason).
...
The version of CIDER and cider-nrepl are always kept in sync. If you're tracking the
